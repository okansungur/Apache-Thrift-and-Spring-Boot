...
public class StudentService {
  ...
  public interface Iface {
    ...
    public StudentResource get(int id) throws InvalidOperationException, org.apache.thrift.TException;

    public void save(StudentResource resource) throws InvalidOperationException, org.apache.thrift.TException;

    public java.util.List<StudentResource> getList() throws InvalidOperationException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void get(int id, org.apache.thrift.async.AsyncMethodCallback<StudentResource> resultHandler) throws org.apache.thrift.TException;

    public void save(StudentResource resource, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void getList(org.apache.thrift.async.AsyncMethodCallback<java.util.List<StudentResource>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public StudentResource recv_get() throws InvalidOperationException, org.apache.thrift.TException
    {
    ...
    public void send_save(StudentResource resource) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<StudentResource> recv_getList() throws InvalidOperationException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class get_call extends org.apache.thrift.async.TAsyncMethodCall<StudentResource> {
      private int id;
      public get_call(int id, org.apache.thrift.async.AsyncMethodCallback<StudentResource> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public StudentResource getResult() throws InvalidOperationException, org.apache.thrift.TException {
    ...
    public static class getList_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<StudentResource>> {
      public getList_call(org.apache.thrift.async.AsyncMethodCallback<java.util.List<StudentResource>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
      ...
      public java.util.List<StudentResource> getResult() throws InvalidOperationException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class get<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, get_args, StudentResource> {
      public get() {
        super("get");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<StudentResource> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<StudentResource>() { 
          public void onComplete(StudentResource o) {
            get_result result = new get_result();
            result.success = o;
            try {
      ...
      public void start(I iface, get_args args, org.apache.thrift.async.AsyncMethodCallback<StudentResource> resultHandler) throws org.apache.thrift.TException {
    ...
    public static class getList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getList_args, java.util.List<StudentResource>> {
      public getList() {
        super("getList");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<StudentResource>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<StudentResource>>() { 
          public void onComplete(java.util.List<StudentResource> o) {
            getList_result result = new getList_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getList_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<StudentResource>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class get_result implements org.apache.thrift.TBase<get_result, get_result._Fields>, java.io.Serializable, Cloneable, Comparable<get_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable StudentResource success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, StudentResource.class)));
    ...
    public get_result(get_result other) {
      if (other.isSetSuccess()) {
        this.success = new StudentResource(other.success);
      }
      if (other.isSetE()) {
    ...
    @org.apache.thrift.annotation.Nullable
    public StudentResource getSuccess() {
      return this.success;
    }

    public get_result setSuccess(@org.apache.thrift.annotation.Nullable StudentResource success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((StudentResource)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new StudentResource();
  ...
  public static class save_args implements org.apache.thrift.TBase<save_args, save_args._Fields>, java.io.Serializable, Cloneable, Comparable<save_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable StudentResource resource; // required
    ...
    public save_args(save_args other) {
      if (other.isSetResource()) {
        this.resource = new StudentResource(other.resource);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public StudentResource getResource() {
      return this.resource;
    }

    public save_args setResource(@org.apache.thrift.annotation.Nullable StudentResource resource) {
      this.resource = resource;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case RESOURCE:
        if (value == null) {
          ...
          setResource((StudentResource)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, save_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // RESOURCE
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.resource = new StudentResource();
...
;
  ...
  public static class getList_result implements org.apache.thrift.TBase<getList_result, getList_result._Fields>, java.io.Serializable, Cloneable, Comparable<getList_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<StudentResource> success; // required
    public @org.apache.thrift.annotation.Nullable InvalidOperationException e; // required
    ...
    public getList_result(
      java.util.List<StudentResource> success,
      InvalidOperationException e)
    {
      this();
      this.success = success;
    ...
    public getList_result(getList_result other) {
      if (other.isSetSuccess()) {
        java.util.List<StudentResource> __this__success = new java.util.ArrayList<StudentResource>(other.success.size());
        for (StudentResource other_element : other.success) {
          __this__success.add(new StudentResource(other_element));
        }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<StudentResource> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(StudentResource elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<StudentResource>();
      }
      this.success.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<StudentResource> getSuccess() {
      return this.success;
    }

    public getList_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<StudentResource> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<StudentResource>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<StudentResource>(_list0.size);
                  @org.apache.thrift.annotation.Nullable StudentResource _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new StudentResource();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (StudentResource _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (StudentResource _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<StudentResource>(_list5.size);
            @org.apache.thrift.annotation.Nullable StudentResource _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new StudentResource();
              _elem6.read(iprot);
